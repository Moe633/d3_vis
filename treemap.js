    ...
    return function(t) {
        ...
        3: function(t, n, e) {
            ...
            function p(t, n) {
                ...
                function b(i) {
                    var l = null == r ? n.ticks ? n.ticks.apply(n, e) : n.domain() : r,
                        ...
                        z = E.select("line"),
                        P = E.select("text");
                    S = S.merge(S.enter().insert("path", ".tick").attr("class", "domain").attr("stroke", "#000")), E = E.merge(C), z = z.merge(C.append("line").attr("stroke", "#000").attr(m + "2", _ * v)), P = P.merge(C.append("text").attr("fill", "#000").attr(m, _ * b).attr("dy", t === o ? "0em" : t === c ? "0.71em" : "0.32em")), i !== N && (S = S.transition(i), E = E.transition(i), z = z.transition(i), P = P.transition(i), A = A.transition(i).attr("opacity", s).attr("transform", (function(t) {
                    ...
                    }))), A.remove(), S.attr("d", t === f || t == a ? "M" + _ * g + "," + M + "H0.5V" + T + "H" + _ * g : "M" + M + "," + _ * g + "V0.5H" + T + "V" + _ * g), E.attr("opacity", 1).attr("transform", (function(t) {
                        return x(k(t))
                    })), z.attr(m + "2", _ * v), P.attr(m, _ * b).text(h), N.filter(d).attr("fill", "none").attr("font-size", 10).attr("font-family", "sans-serif").attr("text-anchor", t === a ? "start" : t === f ? "end" : "middle"), N.each((function() {
                        this.__axis = k
                    }))
                }
            ...
            var vt = pt,
                ...
                yt = function(t) {
                    return gt(E(t).call(document.documentElement))
                },
                _t = 0;
            ...
            var Dt = function() {
                    ...
                    function d() {
                        if (!r && i.apply(this, arguments)) {
                            ...
                            o && (gt(ut.view).on("mousemove.drag", p, !0).on("mouseup.drag", v, !0), At(ut.view), St(), e = !1, t = ut.clientX, n = ut.clientY, o("start"))
                        }
                    }
                    ...
                    function v() {
                        gt(ut.view).on("mousemove.drag mouseup.drag", null), Ct(ut.view, e), Et(), c.mouse("end")
                    }
                    ...
                    function m(t, n, e, r, i) {
                        ...
                        if (st(new Pt(h, "beforestart", u, t, s, d[0], d[1], 0, 0, p), (function() {
                            ...
                            st(new Pt(h, f, u, t, v, d[0] + a, d[1] + l, d[0] - g[0], d[1] - g[1], p), p.apply, p, [f, r, i])
                        }
                    }
            ...
            function zi(t) {
                ...
                function s() {
                    ...
                    if (r.apply(this, arguments)) {
                        ...
                        var R = gt(_).attr("pointer-events", "none"),
                            L = R.selectAll(".overlay").attr("cursor", yi[m]);
                            ...
                            var q = gt(ut.view).on("keydown.brush", (function() {
                                switch (ut.keyCode) {
                                    ...
                                    case 18:
                                        ...
                                        break;
                                    case 32:
                                        x !== hi && x !== di || (b < 0 ? f = s - d : b > 0 && (e = i - d), w < 0 ? l = h - p : w > 0 && (u = o - p), x = li, L.attr("cursor", yi.selection), U());
                                        break;
                                    default:
                                        return
                                }
                                ...
                                switch (ut.keyCode) {
                                    ...
                                    case 18:
                                        ...
                                        break;
                                    case 32:
                                        x === li && (ut.altKey ? (b && (f = s - d * b, e = i + d * b), w && (l = h - p * w, u = o + p * w), x = di) : (b < 0 ? f = s : b > 0 && (e = i), w < 0 ? l = h : w > 0 && (u = o), x = hi), L.attr("cursor", yi[m]), U());
                                        break;
                                    default:
                                        return
                                }
                    ...
                    function D() {
                        var t = Mt(_);
                        !C || g || y || (Math.abs(t[0] - P[0]) > Math.abs(t[1] - P[1]) ? y = !0 : g = !0), P = t, v = !0, fi(), U()
                    }
                    ...
                    function U() {
                        ...
                        s < i && (b *= -1, t = e, e = f, f = t, t = i, i = s, s = t, m in _i && L.attr("cursor", yi[m = _i[m]])), h < o && (w *= -1, t = u, u = l, l = t, t = o, o = h, h = t, m in mi && L.attr("cursor", yi[m = mi[m]])), M.selection && (k = M.selection), g && (i = k[0][0], s = k[1][0]), y && (o = k[0][1], h = k[1][1]), k[0][0] === i && k[0][1] === o && k[1][0] === s && k[1][1] === h || (M.selection = [
                            [i, o],
                            [s, h]
                        ], a.call(_), O.brush())
                    }
                    ...
                    function j() {
                        ...
                        R.attr("pointer-events", "all"), L.attr("cursor", yi.overlay), M.selection && (k = M.selection), Ni(k) && (M.selection = null, a.call(_)), O.end()
                    }
                }
                    ...
                    function u(u) {
                        ...
                        for (s = -1; ++s < h;)
                            for (l = s - 1; ++l < h;) {
                                var T = _[l * h + s],
                                    k = _[s * h + l];
                                (T.value || k.value) && g.push(T.value < k.value ? {
                                    source: k,
                                    target: T
                                } : {
                                    source: T,
            ...
            var $i = function() {
                    ...
                    function o() {
                        var o, a = ji.call(arguments),
                            ...
                            g = r.apply(this, a) - Li,
                            y = i.apply(this, a) - Li;
                        if (u || (u = o = Object(Ii.a)()), u.moveTo(d, p), u.arc(0, 0, s, l, h), l === g && h === y || (u.quadraticCurveTo(0, 0, v * Pi(g), v * Oi(g)), u.arc(0, 0, v, g, y)), u.quadraticCurveTo(0, 0, d, p), u.closePath(), o) return u = null, o + "" || null
                    }
            ...
            var Vu, $u, Wu, Zu = function(t) {
                ...
                Gu = ["y", "z", "a", "f", "p", "n", "µ", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"],
                Qu = function(t) {
                    ...
                    function c(t) {
                        ...
                        function m(t) {
                            ...
                            if ("c" === p) x = y(t) + x, t = "";
                                ...
                                var b = (t = +t) < 0;
                                if (t = y(Math.abs(t), d), b && 0 == +t && (b = !1), m = (b ? "(" === c ? c : "-" : "-" === c || "(" === c ? "" : c) + m, x = ("s" === p ? Gu[8 + zu / 3] : "") + x + (b && "(" === c ? ")" : ""), _)
            ...
            function Vo(t, n) {
                Bo.point = $o, Lo = t, qo = n, Do = t *= ho, Uo = yo(n = (n *= ho) / 2 + fo), jo = wo(n)
            }
            ...
            function Xa(t, n) {
                t *= ho;
                var e = yo(n *= ho);
                Da = e * yo(t), Ua = e * wo(t), ja = wo(n), Ia.point = Va, Ba(Da, Ua, ja)
            }
            ...
            function Va(t, n) {
                ...
                var e = yo(n *= ho),
                    ...
                    i = e * wo(t),
                    u = wo(n),
                    o = go(To((o = Ua * u - ja * i) * o + (o = ja * r - Da * u) * o + (o = Da * i - Ua * r) * o), Da * r + Ua * i + ja * u);
            ...
            function Ga(t, n) {
                ...
                var e = yo(n);
                Da = e * yo(t), Ua = e * wo(t), ja = wo(n), Ba(Da, Ua, ja)
            }
            ...
            var Ja = function(t) {
                    ...
                    var n = Pa,
                        ...
                        r = Ra,
                        i = n * n + e * e + r * r;
                    return i < 1e-12 && (n = Aa, e = Ca, r = za, ka < oo && (n = Na, e = Sa, r = Ea), (i = n * n + e * e + r * r) < 1e-12) ? [NaN, NaN] : [go(e, n) * lo, So(r / To(i)) * lo]
                },
                Ka = function(t) {
                    return function() {
                        return t
            ...
            function uc(t, n) {
                ...
                function o(t, n) {
                    var o = yo(n),
                        ...
                        f = wo(n),
                        s = f * e + a * r;
                    return [go(c * i - s * u, a * e - f * r), So(s * i + c * u)]
                }
                return o.invert = function(t, n) {
                    var o = yo(n),
                        ...
                        f = wo(n),
                        s = f * i - c * u;
                    return [go(c * i + f * u, a * e + s * r), So(s * e - a * r)]
                }, o
            }
            nc.invert = nc;
            var oc = function(t) {
            ...
            function ac(t, n, e, r, i, u) {
                if (e) {
                    ...
                    for (var f, s = i; r > 0 ? s > u : s < u; s -= c) f = Zo([o, -a * yo(s), -a * wo(s)]), t.point(f[0], f[1])
                }
            }
                        ...
                        if (s = (f = t[a]).length)
                            for (var f, s, l = f[s - 1], h = l[0], d = l[1] / 2 + fo, p = wo(d), v = yo(d), g = 0; g < s; ++g, h = _, p = x, v = b, l = y) {
                                var y = f[g],
                                    ...
                                    k = T > ao,
                                    N = p * x;
                                if (vc.add(go(N * M * wo(T), v * b + N * yo(T))), u += k ? w + M * so : w, k ^ h >= e ^ _ >= e) {
                                    var S = Jo(Go(l), Go(y));
                                    na(S);
                                    var E = Jo(i, S);
                                    na(E);
                ...
                bc = function(t) {
                    ...
                    function o(t, e, r) {
                        ...
                        if (!(g < 0)) {
                            ...
                            var T = b - x,
                                k = po(T - ao) < oo;
                            if (!k && M < w && (m = w, w = M, M = m), k || T < oo ? k ? w + M > 0 ^ _[1] < (po(_[0] - x) < oo ? w : M) : w <= _[1] && _[1] <= M : T > ao ^ (x <= _[0] && _[0] <= b)) {
                                var N = ta(d, (-p + y) / v);
                                return Ko(N, h), [_, Zo(N)]
                            }
                        }
                    }
                ...
                return function(a) {
                    var f, s, l, h, d, p, v, g, y, _, m, x = a,
                        ...
                        w = {
                            point: M,
                            lineStart: function() {
                                w.point = T, s && s.push(l = []), _ = !0, y = !1, v = g = NaN
                            },
                            lineEnd: function() {
                                f && (T(h, d), p && y && b.rejoin(), f.push(b.result())), w.point = M, y && x.lineEnd()
                            },
                            polygonStart: function() {
                                x = b, f = [], s = [], m = !0
                            },
                    ...
                    function T(r, o) {
                        ...
                        if (s && l.push([r, o]), _) h = r, d = o, p = a, _ = !1, a && (x.lineStart(), x.point(r, o));
                            ...
                            var c = [v = Math.max(Tc, Math.min(Mc, v)), g = Math.max(Tc, Math.min(Mc, g))],
            ...
            function Oc(t, n) {
                Nc = t *= ho, Sc = wo(n *= ho), Ec = yo(n), zc.point = Rc
            }
            ...
            function Rc(t, n) {
                ...
                var e = wo(n *= ho),
                    ...
                    a = Ec * e - Sc * r * u,
                    c = Sc * e + Ec * r * u;
                Cc.add(go(To(o * o + a * a), c)), Nc = t, Sc = e, Ec = r
            }
            var Lc = function(t) {
            ...
            function Gc() {
                ...
                return _.lines = function() {
                    ...
                    return arguments.length ? (y = +r, f = Wc(o, u, 90), s = Zc(n, t, y), l = Wc(c, a, 90), h = Zc(i, e, y), _) : y
                }, _.extentMajor([
                    [-180, -90 + oo],
                    [180, 90 - oo]
                ]).extentMinor([
                    ...
                    var e = t[0] * ho,
                        ...
                        g = p ? function(t) {
                            var n = wo(t *= p) / v,
                                ...
                                i = e * l + n * d,
                                u = e * a + n * f;
                            return [go(i, r) * lo, go(u, To(r * r + i * i)) * lo]
                        } : function() {
                            return [e * lo, r * lo]
                        };
                        ...
                        function e(r, i, u, o, a, c, f, s, l, h, d, p, v, g) {
                            ...
                            if (m > 4 * n && v--) {
                                var x = o + h,
                                    ...
                                    M = To(x * x + b * b + w * w),
                                    T = So(w /= M),
                                    k = po(po(w) - 1) < oo || po(u - l) < oo ? (u + l) / 2 : go(b, x),
                                    N = t(k, T),
                                    S = N[0],
                                    E = N[1],
                                    A = S - r,
                                    C = E - i,
                                    z = _ * A - y * C;
                                (z * z / m > n || po((y * A + _ * C) / m - .5) > .3 || o * h + a * d + c * p < ls) && (e(r, i, u, o, a, c, S, E, k, x /= M, b /= M, w, v, g), g.point(S, E), e(S, E, k, x, b, w, f, s, l, h, d, p, v, g))
                            }
                        }
                        return function(n) {
            ...
            function vs(t) {
                ...
                return k.stream = function(t) {
                        ...
                        return arguments.length ? (g = t[0] % 360 * ho, y = t[1] % 360 * ho, _ = t.length > 2 ? t[2] % 360 * ho : 0, E()) : [g * lo, y * lo, _ * lo]
            ...
            function ys(t, n) {
                ...
                return o.invert = function(t, n) {
                    var e = u - n;
                    return [go(t, po(e)) / r * Mo(e), So((i - (t * t + e * e) * r * r) / (2 * r))]
                }, o
            }
            var _s = function() {
            ...
            function Ls(t, n) {
                ...
                return u.invert = function(t, n) {
                    var e = i - n;
                    return [go(t, po(e)) / r * Mo(e), i - Mo(r) * To(t * t + e * e)]
                }, u
            }
            var qs = function() {
                return gs(Ls).scale(131.154).center([0, 13.9389])
            };
            ...
            var ig = function() {
                    return rg(Wd, Xd, Cd, Sd, Td, bd, _d, dd, zp).domain([new Date(2e3, 0, 1), new Date(2e3, 0, 2)])
                },
                ug = function() {
                    return rg(Tp, bp, op, rp, tp, Qd, _d, dd, Op).domain([Date.UTC(2e3, 0, 1), Date.UTC(2e3, 0, 2)])
                },
                og = function(t) {
                ...
                lg = Ne(Rn(300, .5, 0), Rn(-240, .5, 1)),
                hg = Ne(Rn(-100, .75, .35), Rn(80, 1.5, .8)),
                dg = Ne(Rn(260, .75, .35), Rn(80, 1.5, .8)),
                pg = Rn(),
                vg = function(t) {
            ...
            Ng.prototype = {
                ...
                insert: function(t, n) {
                    ...
                    for (n.L = n.R = null, n.U = e, n.C = !0, t = n; e && e.C;) e === (r = e.U).L ? (i = r.R) && i.C ? (e.C = i.C = !1, r.C = !0, t = r) : (t === e.R && (Eg(this, e), e = (t = e).U), e.C = !1, r.C = !0, Ag(this, r)) : (i = r.L) && i.C ? (e.C = i.C = !1, r.C = !0, t = r) : (t === e.L && (Ag(this, e), e = (t = e).U), e.C = !1, r.C = !0, Eg(this, r)), e = t.U;
                    this._.C = !1
                },
                remove: function(t) {
                    ...
                    if (e = u ? o ? Cg(o) : u : o, i ? i.L === t ? i.L = e : i.R = e : this._ = e, u && o ? (r = e.C, e.C = t.C, e.L = u, u.U = e, e !== o ? (i = e.U, e.U = t.U, t = e.R, i.L = t, e.R = o, o.U = e) : (e.U = i, i = e, t = e.R)) : (r = t.C, t = e), t && (t.U = i), !r)
                        if (t && t.C) t.C = !1;
                            ...
                            do {
                                if (t === this._) break;
                                if (t === i.L) {
                                    if ((n = i.R).C && (n.C = !1, i.C = !0, Eg(this, i), n = i.R), n.L && n.L.C || n.R && n.R.C) {
                                        n.R && n.R.C || (n.L.C = !1, n.C = !0, Ag(this, n), n = i.R), n.C = i.C, i.C = n.R.C = !1, Eg(this, i), t = this._;
                                        break
                                    }
                                } else if ((n = i.L).C && (n.C = !1, i.C = !0, Ag(this, i), n = i.L), n.L && n.L.C || n.R && n.R.C) {
                                    n.L && n.L.C || (n.R.C = !1, n.C = !0, Eg(this, n), n = i.L), n.C = i.C, i.C = n.L.C = !1, Ag(this, i), t = this._;
                                    break
                                }
                                n.C = !0, t = i, i = i.U
                            } while (!t.C);
            ...
            function Pg(t, n, e, r) {
                var i = [null, null],
                    u = ty.push(i) - 1;
                return i.left = t, i.right = n, e && Rg(i, t, n, e), r && Rg(i, n, t, r), Jg[t.index].halfedges.push(u), Jg[n.index].halfedges.push(u), i
            }
                        ...
                        if (!(h >= -ey)) {
                            var d = c * c + f * f,
                                ...
                                y = Ig.pop() || new function() {
                                    Sg(this), this.x = this.y = this.arc = this.site = this.cy = null
                                };
            ...
            function Bg(t) {
                var n = t.circle;
                n && (n.P || (Fg = n.N), Kg.remove(n), Ig.push(n), Sg(n), t.circle = null)
            }
            var Hg = [];

            function Xg(t) {
                var n = Hg.pop() || new function() {
                    Sg(this), this.edge = this.site = this.circle = null
                };
                return n.site = t, n
            }

            function Vg(t) {
                Bg(t), Qg.remove(t), Hg.push(t), Sg(t)
            }
            ...
            function $g(t) {
                ...
                c = a[0], (f = a[l - 1]).edge = Pg(c.site, f.site, null, i), Yg(c), Yg(f)
            }

            function Wg(t) {
                for (var n, e, r, i, u = t[0], o = t[1], a = Qg._; a;)
                    if ((r = Zg(a, o) - u) > ny) a = a.L;
                    else {
                        if (!((i = u - Gg(a, o)) > ny)) {
                ...
                if (Qg.insert(n, c), n || e) {
                    if (n === e) return Bg(n), e = Xg(n.site), Qg.insert(c, e), c.edge = e.edge = Pg(n.site, c.site), Yg(n), void Yg(e);
                    if (e) {
                        Bg(n), Bg(e);
                        var f = n.site,
                            s = f[0],
                        ...
                        Rg(e.edge, f, p, x), c.edge = Pg(f, t, null, x), e.edge = Pg(t, p, null, x), Yg(n), Yg(e)
                    } else c.edge = Pg(n.site, c.site)
                }
            }
            ...
            function iy(t, n) {
                ...
                for (ty = [], Jg = new Array(t.length), Qg = new zg, Kg = new zg;;)
                    if (i = Fg, u && (!i || u[1] < i.y || u[1] === i.y && u[0] < i.x)) u[0] === e && u[1] === r || (Wg(u), e = u[0], r = u[1]), u = t.pop();
                        ...
                        for (var t, n, e, r, i = 0, u = Jg.length; i < u; ++i)
                            if ((t = Jg[i]) && (r = (n = t.halfedges).length)) {
                                var o = new Array(r),
                                    a = new Array(r);
                                for (e = 0; e < r; ++e) o[e] = e, a[e] = Dg(t, ty[n[e]]);
                    ...
                    var o = +n[0][0],
                        ...
                        f = +n[1][1];
                    ! function(t, n, e, r) {
                        for (var i, u = ty.length; u--;) qg(i = ty[u], t, n, e, r) && Lg(i, t, n, e, r) && (Math.abs(i[0][0] - i[1][0]) > ny || Math.abs(i[0][1] - i[1][1]) > ny) || delete ty[u]
                    }(o, a, c, f),
                    function(t, n, e, r) {
                        ...
                        for (i = 0; i < g; ++i)
                            if (u = Jg[i]) {
                                ...
                                for (a = 0, f = c.length; a < f;) p = (d = jg(u, ty[c[a]]))[0], v = d[1], l = (s = Ug(u, ty[c[++a % f]]))[0], h = s[1], (Math.abs(p - l) > ny || Math.abs(v - h) > ny) && (c.splice(a, 0, ty.push(Og(o, d, Math.abs(p - t) < ny && r - v > ny ? [t, Math.abs(l - t) < ny ? h : r] : Math.abs(v - r) < ny && e - p > ny ? [Math.abs(h - r) < ny ? l : e, r] : Math.abs(p - e) < ny && v - n > ny ? [e, Math.abs(l - e) < ny ? h : n] : Math.abs(v - n) < ny && p - t > ny ? [Math.abs(h - n) < ny ? l : t, n] : null)) - 1), ++f);
                                f && (y = !1)
                            } if (y) {
                            var _, m, x, b = 1 / 0;
                            ...
                            if (y) {
                                var w = [t, n],
                                    ...
                                    T = [e, r],
                                    k = [e, n];
                                y.halfedges.push(ty.push(Og(o = y.site, w, M)) - 1, ty.push(Og(o, M, T)) - 1, ty.push(Og(o, T, k)) - 1, ty.push(Og(o, k, w)) - 1)
                            }
                        }
            ...
            var _y = function() {
                ...
                function g(t) {
                    t.property("__zoom", py).on("wheel.zoom", M).on("mousedown.zoom", k).on("dblclick.zoom", N).filter(o).on("touchstart.zoom", S).on("touchmove.zoom", E).on("touchend.zoom touchcancel.zoom", A).style("touch-action", "none").style("-webkit-tap-highlight-color", "rgba(0,0,0,0)")
                }
                ...
                function S() {
                    if (e.apply(this, arguments)) {
                        var n, r, i, u, o = b(this, arguments),
                            a = ut.changedTouches,
                            c = a.length;
                        for (sy(), r = 0; r < c; ++r) i = a[r], u = [u = kt(this, a, i.identifier), this.__zoom.invert(u), i.identifier], o.touch0 ? o.touch1 || (o.touch1 = u) : (o.touch0 = u, n = !0);
                ...
                function E() {
                    var n, e, r, u, o = b(this, arguments),
                        a = ut.changedTouches,
                        f = a.length;
                    for (ly(), t && (t = clearTimeout(t)), n = 0; n < f; ++n) e = a[n], r = kt(this, a, e.identifier), o.touch0 && o.touch0[2] === e.identifier ? o.touch0[0] = r : o.touch1 && o.touch1[2] === e.identifier && (o.touch1[0] = r);
            ...
            var u = {
                ...
                update: function(t, n, e, u) {
                    if (Object(i.b)(this, u, {
                        ...
                        var o = n.clientWidth,
                            a = n.clientHeight,
                            c = u.fields.dimension_like,
                            f = u.fields.measure_like[0],
                            s = Object(i.a)(f.value_format) || function(t) {
                                return t.toString()
                            },
                            l = r.scaleOrdinal().range(e.color_range);
                        ...
                        var h = r.treemap().size([o, a - 16]).tile(r.treemapSquarify.ratio(1)).paddingOuter(1).paddingTop((function(t) {
                                return 1 === t.depth ? 16 : 0
                            })).paddingInner(1).round(!0),
                            d = this.svg.html("").attr("width", "100%").attr("height", "100%").append("g").attr("transform", "translate(0,16)"),
                            p = d.append("text").attr("y", -5).attr("x", 4),
                            v = r.hierarchy(function(t) {
                                var n = {};
                                return t.forEach((function(t) {
                                    var e = n;
                                    t.taxonomy.value.forEach((function(t) {
                                        e[t] = t in e ? e[t] : {}, e = e[t]
                                    })), e.__data = t
                                })), {
                                    name: "root",
                        ...
                        h(v);
                        var g = d.selectAll(".node").data(v.descendants()).enter().append("g").attr("transform", (function(t) {
                            return "translate(" + t.x0 + "," + t.y0 + ")"
                        })).attr("class", (function(t, n) {
                            return "node depth-" + t.depth
                        })).style("stroke-width", 1.5).style("cursor", "pointer").on("click", (function(t) {
                            return console.log(t)
                        })).on("mouseenter", (function(t) {
                            var n = t.ancestors();
                            p.text(n.map((function(t) {
                                return t.data.name
                            })).slice(0, -1).reverse().join("-") + ": " + s(t.value)), d.selectAll("g.node rect").style("stroke", null).filter((function(t) {
                                return n.indexOf(t) > -1
                            })).style("stroke", "#fff")
                        })).on("mouseleave", (function(t) {
                            p.text(""), d.selectAll("g.node rect").style("stroke", (function(t) {
                                return null
                            }))
                        }));
                        g.append("rect").attr("id", (function(t, n) {
                            return "rect-" + n
                        })).attr("width", (function(t) {
                            return t.x1 - t.x0
                        })).attr("height", (function(t) {
                            ...
                            var n = t.ancestors().map((function(t) {
                                ...
                                e = [l(n), "#ddd"];
                            return r.scaleLinear().domain([1, 6.5]).range(e)(t.depth)
                        })), g.append("clipPath").attr("id", (function(t, n) {
                            return "clip-" + n
                        })).append("use").attr("xlink:href", (function(t, n) {
                            return "#rect-" + n
                        })), g.append("text").style("opacity", (function(t) {
                            return 1 === t.depth ? 1 : 0
                        })).attr("clip-path", (function(t, n) {
                            return "url(#clip-" + n + ")"
                        })).attr("y", (function(t) {
                            return 1 === t.depth ? "13" : "10"
                        })).attr("x", 2).style("font-family", "Helvetica, Arial, sans-serif").style("fill", "white").style("font-size", (function(t) {
            ...
            var M = function() {
                ...
                function S() {
                    var i, y, _, m = +t.apply(this, arguments),
                        ...
                        E = u(S - b),
                        A = S > b;
                    if (N || (N = i = Object(r.a)()), x < m && (y = x, x = m, m = y), x > h)
